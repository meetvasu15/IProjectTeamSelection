...
<portlet:renderURL var="preferencesFormURL">
	<portlet:param name="jspPage" value="/html/anshu/form.jsp"/>
</portlet:renderURL>
...
listBooksURL.setParameter("jspPage", "/html/anshu/list.jsp");
%>
<a href="<%= listBooksURL.toString() %>">Show all students &raquo;</a>
