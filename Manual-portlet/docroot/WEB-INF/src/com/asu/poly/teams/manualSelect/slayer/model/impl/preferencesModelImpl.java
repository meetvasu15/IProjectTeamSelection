...
import com.asu.poly.teams.manualSelect.slayer.model.preferencesModel;
import com.asu.poly.teams.manualSelect.slayer.model.preferencesSoap;
...
/**
 * The base model implementation for the preferences service. Represents a row in the &quot;manualSelect_preferences&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.asu.poly.teams.manualSelect.slayer.model.preferencesModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link preferencesImpl}.
 * </p>
 *
 * @author Eshwari
 * @see preferencesImpl
 * @see com.asu.poly.teams.manualSelect.slayer.model.preferences
 * @see com.asu.poly.teams.manualSelect.slayer.model.preferencesModel
 * @generated
 */
@JSON(strict = true)
public class preferencesModelImpl extends BaseModelImpl<preferences>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a preferences model instance should use the {@link com.asu.poly.teams.manualSelect.slayer.model.preferences} interface instead.
	 */
	public static final String TABLE_NAME = "manualSelect_preferences";
	...
	public static final String TABLE_SQL_CREATE = "create table manualSelect_preferences (facultyID LONG not null primary key,ASUID VARCHAR(75) null,preference1 VARCHAR(75) null,preference2 VARCHAR(75) null,preference3 VARCHAR(75) null,dateAdded DATE null,dateModified DATE null)";
	public static final String TABLE_SQL_DROP = "drop table manualSelect_preferences";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.asu.poly.teams.manualSelect.slayer.model.preferences"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.asu.poly.teams.manualSelect.slayer.model.preferences"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.asu.poly.teams.manualSelect.slayer.model.preferences"));
