...
import com.asu.poly.teams.manualSelect.slayer.model.ProjectdetailModel;
import com.asu.poly.teams.manualSelect.slayer.model.ProjectdetailSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.asu.poly.teams.manualSelect.slayer.model.ProjectdetailModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ProjectdetailImpl}.
 * </p>
 *
 * @author Eshwari
 * @see ProjectdetailImpl
 * @see com.asu.poly.teams.manualSelect.slayer.model.Projectdetail
 * @see com.asu.poly.teams.manualSelect.slayer.model.ProjectdetailModel
 * @generated
 */
@JSON(strict = true)
public class ProjectdetailModelImpl extends BaseModelImpl<Projectdetail>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a projectdetail model instance should use the {@link com.asu.poly.teams.manualSelect.slayer.model.Projectdetail} interface instead.
	 */
	...
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.asu.poly.teams.manualSelect.slayer.model.Projectdetail"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.asu.poly.teams.manualSelect.slayer.model.Projectdetail"));
	...
	public Object clone() {
		...
		projectdetailImpl.setSponsor(getSponsor());
		projectdetailImpl.setProjectrequiredskill(getProjectrequiredskill());
		projectdetailImpl.setContact(getContact());
		projectdetailImpl.setStatus(getStatus());
		projectdetailImpl.setLink(getLink());
	...
	public CacheModel<Projectdetail> toCacheModel() {
		...
		projectdetailCacheModel.sponsor = getSponsor();

		String sponsor = projectdetailCacheModel.sponsor;

		if ((sponsor != null) && (sponsor.length() == 0)) {
			projectdetailCacheModel.sponsor = null;
		}
		...
		projectdetailCacheModel.status = getStatus();

		String status = projectdetailCacheModel.status;

		if ((status != null) && (status.length() == 0)) {
			projectdetailCacheModel.status = null;
		}

		projectdetailCacheModel.link = getLink();

		String link = projectdetailCacheModel.link;

		if ((link != null) && (link.length() == 0)) {
			projectdetailCacheModel.link = null;
		}
