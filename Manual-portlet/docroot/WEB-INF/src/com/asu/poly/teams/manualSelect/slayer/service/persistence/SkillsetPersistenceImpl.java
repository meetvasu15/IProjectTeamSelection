...
import com.asu.poly.teams.manualSelect.slayer.NoSuchSkillsetException;
import com.asu.poly.teams.manualSelect.slayer.model.Skillset;
import com.asu.poly.teams.manualSelect.slayer.model.impl.SkillsetImpl;
import com.asu.poly.teams.manualSelect.slayer.model.impl.SkillsetModelImpl;
...
public class SkillsetPersistenceImpl extends BasePersistenceImpl<Skillset>
	 ...
	 * @throws com.asu.poly.teams.manualSelect.slayer.NoSuchSkillsetException if a skillset with the primary key could not be found
	...
	/**
	 * Returns the skillset with the primary key or throws a {@link com.asu.poly.teams.manualSelect.slayer.NoSuchSkillsetException} if it could not be found.
	 *
	 * @param studentID the primary key of the skillset
	 * @return the skillset
	 * @throws com.asu.poly.teams.manualSelect.slayer.NoSuchSkillsetException if a skillset with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.teams.manualSelect.slayer.model.Skillset")));
