...
public class FooLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return FooLocalServiceUtil.addFoo((com.asu.poly.teams.manualSelect.slayer.model.Foo)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return FooLocalServiceUtil.deleteFoo((com.asu.poly.teams.manualSelect.slayer.model.Foo)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return FooLocalServiceUtil.updateFoo((com.asu.poly.teams.manualSelect.slayer.model.Foo)arguments[0]);
		}
