...
public class StudentLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return StudentLocalServiceUtil.addStudent((com.asu.poly.teams.manualSelect.slayer.model.Student)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return StudentLocalServiceUtil.deleteStudent((com.asu.poly.teams.manualSelect.slayer.model.Student)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return StudentLocalServiceUtil.updateStudent((com.asu.poly.teams.manualSelect.slayer.model.Student)arguments[0]);
		}
