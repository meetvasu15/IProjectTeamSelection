...
import com.asu.iproject.student.skillset.model.SkillsetClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Collect-Student-Skillset-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Collect-Student-Skillset-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.asu.iproject.student.skillset.model.impl.SkillsetImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.asu.iproject.student.skillset.NoSuchSkillsetException")) {
			return new com.asu.iproject.student.skillset.NoSuchSkillsetException();
		}
