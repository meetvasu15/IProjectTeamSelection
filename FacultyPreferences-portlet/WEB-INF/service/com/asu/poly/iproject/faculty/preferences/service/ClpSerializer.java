...
import com.asu.poly.iproject.faculty.preferences.model.ProjectdetailClp;
import com.asu.poly.iproject.faculty.preferences.model.preferencesClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"FacultyPreferences-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "FacultyPreferences-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.asu.poly.iproject.faculty.preferences.model.impl.preferencesImpl")) {
			return translateOutputpreferences(oldModel);
		}

		if (oldModelClassName.equals(
					"com.asu.poly.iproject.faculty.preferences.model.impl.ProjectdetailImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.asu.poly.iproject.faculty.preferences.NoSuchpreferencesException")) {
			return new com.asu.poly.iproject.faculty.preferences.NoSuchpreferencesException();
		}

		if (className.equals(
					"com.asu.poly.iproject.faculty.preferences.NoSuchProjectdetailException")) {
			return new com.asu.poly.iproject.faculty.preferences.NoSuchProjectdetailException();
		}
