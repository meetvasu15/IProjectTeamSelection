...
import com.asu.poly.iproject.teams.addProject.NoSuchProjectdetailException;
...
import com.asu.poly.iproject.teams.addProject.model.impl.ProjectdetailModelImpl;
...
public class ProjectdetailPersistenceImpl extends BasePersistenceImpl<Projectdetail>
	...
	protected Projectdetail toUnwrappedModel(Projectdetail projectdetail) {
		...
		projectdetailImpl.setSponsor(projectdetail.getSponsor());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.iproject.teams.addProject.model.Projectdetail")));
