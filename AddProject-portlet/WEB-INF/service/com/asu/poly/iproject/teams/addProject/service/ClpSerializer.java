...
import com.asu.poly.iproject.teams.addProject.model.ProjectdetailClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"AddProject-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "AddProject-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.asu.poly.iproject.teams.addProject.model.impl.ProjectdetailImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.asu.poly.iproject.teams.addProject.NoSuchProjectdetailException")) {
			return new com.asu.poly.iproject.teams.addProject.NoSuchProjectdetailException();
		}
