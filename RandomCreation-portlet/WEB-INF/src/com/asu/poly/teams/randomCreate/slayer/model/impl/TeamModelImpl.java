...
import com.asu.poly.teams.randomCreate.slayer.model.TeamModel;
import com.asu.poly.teams.randomCreate.slayer.model.TeamSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.asu.poly.teams.randomCreate.slayer.model.TeamModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TeamImpl}.
 * </p>
 *
 * @author asingh64
 * @see TeamImpl
 * @see com.asu.poly.teams.randomCreate.slayer.model.Team
 * @see com.asu.poly.teams.randomCreate.slayer.model.TeamModel
 * @generated
 */
@JSON(strict = true)
public class TeamModelImpl extends BaseModelImpl<Team> implements TeamModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a team model instance should use the {@link com.asu.poly.teams.randomCreate.slayer.model.Team} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.asu.poly.teams.randomCreate.slayer.model.Team"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.asu.poly.teams.randomCreate.slayer.model.Team"),
			true);
	...
	public static Team toModel(TeamSoap soapModel) {
		...
		model.setFaculty0(soapModel.getFaculty0());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.asu.poly.teams.randomCreate.slayer.model.Team"));
	...
	public Object clone() {
		...
		teamImpl.setFaculty0(getFaculty0());
	...
	public CacheModel<Team> toCacheModel() {
		...
		teamCacheModel.faculty0 = getFaculty0();

		String faculty0 = teamCacheModel.faculty0;

		if ((faculty0 != null) && (faculty0.length() == 0)) {
			teamCacheModel.faculty0 = null;
		}
