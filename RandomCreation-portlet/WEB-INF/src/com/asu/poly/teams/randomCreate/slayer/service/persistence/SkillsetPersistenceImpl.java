...
import com.asu.poly.teams.randomCreate.slayer.NoSuchSkillsetException;
import com.asu.poly.teams.randomCreate.slayer.model.Skillset;
import com.asu.poly.teams.randomCreate.slayer.model.impl.SkillsetImpl;
import com.asu.poly.teams.randomCreate.slayer.model.impl.SkillsetModelImpl;
...
public class SkillsetPersistenceImpl extends BasePersistenceImpl<Skillset>
	 ...
	 * @throws com.asu.poly.teams.randomCreate.slayer.NoSuchSkillsetException if a skillset with the primary key could not be found
	...
	protected Skillset toUnwrappedModel(Skillset skillset) {
		...
		skillsetImpl.setProject_Management(skillset.getProject_Management());
		skillsetImpl.setTechnical_Writing(skillset.getTechnical_Writing());
		skillsetImpl.setOral_Presentation(skillset.getOral_Presentation());
		skillsetImpl.setThermo_Fluids(skillset.getThermo_Fluids());
		skillsetImpl.setData_Analysis(skillset.getData_Analysis());
		skillsetImpl.setLeadership(skillset.getLeadership());
		skillsetImpl.setAutomation(skillset.getAutomation());
		skillsetImpl.setMechanical_Design(skillset.getMechanical_Design());
		skillsetImpl.setFabrication_Welding(skillset.getFabrication_Welding());
		skillsetImpl.setMachining_CNC(skillset.getMachining_CNC());
		skillsetImpl.setHeat_Transfer(skillset.getHeat_Transfer());
		skillsetImpl.setElectronics(skillset.getElectronics());
		skillsetImpl.setMicrocontrollers(skillset.getMicrocontrollers());
		skillsetImpl.setGUI_and_Programming(skillset.getGUI_and_Programming());
		skillsetImpl.setLabView(skillset.getLabView());
		skillsetImpl.setEmbedded_Systems(skillset.getEmbedded_Systems());
		skillsetImpl.setCADD(skillset.getCADD());
		skillsetImpl.setFEA(skillset.getFEA());
		skillsetImpl.setCivil_Engineering(skillset.getCivil_Engineering());
	...
	/**
	 * Returns the skillset with the primary key or throws a {@link com.asu.poly.teams.randomCreate.slayer.NoSuchSkillsetException} if it could not be found.
	 *
	 * @param studentID the primary key of the skillset
	 * @return the skillset
	 * @throws com.asu.poly.teams.randomCreate.slayer.NoSuchSkillsetException if a skillset with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.teams.randomCreate.slayer.model.Skillset")));
