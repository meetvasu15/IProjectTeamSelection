...
import com.asu.poly.teams.randomCreate.slayer.service.FacultyLocalService;
import com.asu.poly.teams.randomCreate.slayer.service.FacultyService;
import com.asu.poly.teams.randomCreate.slayer.service.ProjectdetailLocalService;
import com.asu.poly.teams.randomCreate.slayer.service.ProjectdetailService;
import com.asu.poly.teams.randomCreate.slayer.service.SkillsetLocalService;
import com.asu.poly.teams.randomCreate.slayer.service.SkillsetService;
import com.asu.poly.teams.randomCreate.slayer.service.StudentLocalService;
import com.asu.poly.teams.randomCreate.slayer.service.StudentService;
import com.asu.poly.teams.randomCreate.slayer.service.TeamLocalService;
import com.asu.poly.teams.randomCreate.slayer.service.TeamService;
import com.asu.poly.teams.randomCreate.slayer.service.persistence.FacultyPersistence;
import com.asu.poly.teams.randomCreate.slayer.service.persistence.ProjectdetailPersistence;
import com.asu.poly.teams.randomCreate.slayer.service.persistence.SkillsetPersistence;
import com.asu.poly.teams.randomCreate.slayer.service.persistence.StudentPersistence;
import com.asu.poly.teams.randomCreate.slayer.service.persistence.TeamPersistence;
...
/**
 * The base implementation of the skillset local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.asu.poly.teams.randomCreate.slayer.service.impl.SkillsetLocalServiceImpl}.
 * </p>
 *
 * @author asingh64
...
public abstract class SkillsetLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SkillsetLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.asu.poly.teams.randomCreate.slayer.service.SkillsetLocalServiceUtil} to access the skillset local service.
	 */
	...
	public Skillset addSkillset(Skillset skillset) throws SystemException {
		skillset.setNew(true);

		return skillsetPersistence.update(skillset, false);
	}
	 ...
	 */
	public Skillset createSkillset(long studentID) {
		return skillsetPersistence.create(studentID);
	}
	...
	public Skillset deleteSkillset(long studentID)
		throws PortalException, SystemException {
		return skillsetPersistence.remove(studentID);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Skillset deleteSkillset(Skillset skillset) throws SystemException {
	...
	public Skillset fetchSkillset(long studentID) throws SystemException {
		return skillsetPersistence.fetchByPrimaryKey(studentID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Skillset getSkillset(long studentID)
		throws PortalException, SystemException {
		return skillsetPersistence.findByPrimaryKey(studentID);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSkillsetsCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Skillset updateSkillset(Skillset skillset) throws SystemException {
		return updateSkillset(skillset, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Skillset updateSkillset(Skillset skillset, boolean merge)
		throws SystemException {
		skillset.setNew(false);

		return skillsetPersistence.update(skillset, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.asu.poly.teams.randomCreate.slayer.model.Skillset",
	...
	private SkillsetLocalServiceClpInvoker _clpInvoker = new SkillsetLocalServiceClpInvoker();
}