...
import com.addfacultypreferences.slayer.model.impl.LMSBookImpl;
import com.addfacultypreferences.slayer.model.impl.LMSBookModelImpl;
...
public class LMSBookPersistenceImpl extends BasePersistenceImpl<LMSBook>
	...
	protected LMSBook toUnwrappedModel(LMSBook lmsBook) {
		...
		lmsBookImpl.setAsuid(lmsBook.getAsuid());
		lmsBookImpl.setEmail(lmsBook.getEmail());
		lmsBookImpl.setDateAdded(lmsBook.getDateAdded());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.addfacultypreferences.slayer.model.LMSBook")));
