...
import com.asu.poly.iproject.student.preferences.model.ProjectdetailClp;
import com.asu.poly.iproject.student.preferences.model.preferencesClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"StudentPreferences-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "StudentPreferences-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.asu.poly.iproject.student.preferences.model.impl.preferencesImpl")) {
			return translateOutputpreferences(oldModel);
		}

		if (oldModelClassName.equals(
					"com.asu.poly.iproject.student.preferences.model.impl.ProjectdetailImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.asu.poly.iproject.student.preferences.NoSuchpreferencesException")) {
			return new com.asu.poly.iproject.student.preferences.NoSuchpreferencesException();
		}

		if (className.equals(
					"com.asu.poly.iproject.student.preferences.NoSuchProjectdetailException")) {
			return new com.asu.poly.iproject.student.preferences.NoSuchProjectdetailException();
		}
