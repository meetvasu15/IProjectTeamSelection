...
import com.asu.poly.iproject.student.preferences.NoSuchpreferencesException;
import com.asu.poly.iproject.student.preferences.model.impl.preferencesImpl;
import com.asu.poly.iproject.student.preferences.model.impl.preferencesModelImpl;
...
public class preferencesPersistenceImpl extends BasePersistenceImpl<preferences>
	 ...
	 */
	public preferences create(long studentID) {
		preferences preferences = new preferencesImpl();

		preferences.setNew(true);
		preferences.setPrimaryKey(studentID);
	 ...
	 */
	public preferences remove(long studentID)
	...
	protected preferences toUnwrappedModel(preferences preferences) {
		...
		preferencesImpl.setStudentID(preferences.getStudentID());
		...
		preferencesImpl.setPreference4(preferences.getPreference4());
		preferencesImpl.setPreference5(preferences.getPreference5());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public preferences findByPrimaryKey(long studentID)
		throws NoSuchpreferencesException, SystemException {
		preferences preferences = fetchByPrimaryKey(studentID);
		...
		if (preferences == null) {
			...
			try {
				...
				if (preferences != null) {
					...
					EntityCacheUtil.putResult(preferencesModelImpl.ENTITY_CACHE_ENABLED,
						preferencesImpl.class, studentID, _nullpreferences);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.asu.poly.iproject.student.preferences.model.preferences")));
