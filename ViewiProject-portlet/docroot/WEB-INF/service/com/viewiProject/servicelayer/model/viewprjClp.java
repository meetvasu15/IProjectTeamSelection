 ...
 * @author Shruthi
 */
public class viewprjClp extends BaseModelImpl<viewprj> implements viewprj {
	public viewprjClp() {
	}
	...
	public BaseModel<?> getviewprjRemoteModel() {
		return _viewprjRemoteModel;
	}

	public void setviewprjRemoteModel(BaseModel<?> viewprjRemoteModel) {
		_viewprjRemoteModel = viewprjRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			viewprjLocalServiceUtil.addviewprj(this);
		}
		else {
			viewprjLocalServiceUtil.updateviewprj(this);
		}
	}

	@Override
	public viewprj toEscapedModel() {
		return (viewprj)Proxy.newProxyInstance(viewprj.class.getClassLoader(),
			new Class[] { viewprj.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		viewprjClp clone = new viewprjClp();
	...
	public boolean equals(Object obj) {
		...
		viewprjClp viewprj = null;

		try {
			viewprj = (viewprjClp)obj;
		}
	...
	private BaseModel<?> _viewprjRemoteModel;
}