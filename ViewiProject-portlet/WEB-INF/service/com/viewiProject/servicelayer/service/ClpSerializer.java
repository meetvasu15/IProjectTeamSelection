...
import com.viewiProject.servicelayer.model.ProjectdetailClp;
...
public class ClpSerializer {
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.viewiProject.servicelayer.model.impl.ProjectdetailImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.viewiProject.servicelayer.NoSuchProjectdetailException();
		}
