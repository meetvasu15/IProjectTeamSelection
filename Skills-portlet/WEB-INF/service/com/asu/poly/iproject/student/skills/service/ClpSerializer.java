...
import com.asu.poly.iproject.student.skills.model.SkillsetClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Skills-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Skills-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.asu.poly.iproject.student.skills.model.impl.SkillsetImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.asu.poly.iproject.student.skills.NoSuchSkillsetException")) {
			return new com.asu.poly.iproject.student.skills.NoSuchSkillsetException();
		}
